...
const Hero3 = () => {
  ...
  const gridImageWidth = 'w-80'; // Adjust this Tailwind class (e.g., 'w-48', 'w-64', or custom value like 'w-[300px]')
  const gridImageHeight = 'h-80'; // Adjust this Tailwind class (e.g., 'h-48', 'h-64', or custom value like 'h-[300px]')
  const quickViewImageWidth = 'mx-28 w-80'; // Adjust this Tailwind class (e.g., 'w-64', 'w-96', or custom value like 'w-[400px]')
        ...
        <div className="w-full mx-auto px-4 sm:px-6 lg:px-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.length === 0 ? (
              ...
              products.slice(0, 500).map((product, index) => (
                <div
