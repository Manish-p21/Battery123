        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="/w" className="text-gray-600 hover:text-red-600 transition duration-300">
              ...
              <a href="/r" className="text-gray-600 hover:text-red-600 transition duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="/a" className="text-gray-600 hover:text-red-600 transition duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="text-gray-600 text-sm space-y-2">
              <li>
                <a href="/s" className="hover:text-red-600 transition duration-300">
                  Contact Us
                </a>
              </li>
              <li>
                <a href="/d" className="hover:text-red-600 transition duration-300">
                  Returns & Refunds
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/h" className="hover:text-red-600 transition duration-300">
                  Terms & Conditions
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mb-4">
              <input
                ...
                className="w-full p-3 border border-gray-200 rounded-lg text-gray-600 text-sm focus:outline-none focus:ring-2 focus:ring-red-600"
              />
            </div>
            <button
